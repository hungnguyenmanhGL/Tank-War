...
public class Level3Controller : LevelController
{
    static string[] cutsceneDialog =
    {
        ...
        "Operator: Beside the normal turret system, every universal tank like this comes with 2 auxilary modules. " +
            "The functions may vary and it would depend on your operating squad to take advantage of. " +
            "Remember that each module requires time to cooldown before ready to use again. That will be all."
